...
import com.ajaxjs.framework.wechat.miniapp.model.TemplateMsgMp;
import com.ajaxjs.framework.wechat.miniapp.model.TemplateMsgWebApp;
...
public class Message {
    ...
    public void send(String toUser, TemplateMsgMp mpMsg, TemplateMsgWebApp webAppMsg) {
        ...
        Map<String, Object> result = postJson(UNIFORM_SEND_API + appletCfg.getAccessToken(), JsonUtil.toJson(params));
...
//        Map<String, Object> result = Post.apiJsonBody(UNIFORM_SEND_API + appletCfg.getAccessToken(), "", Head.GET_JSON);
    ...
    public static Map<String, Object> postJson(String url, String requestBody) {
        ...
        if (resultJson == null)
            ...
            return JsonUtil.json2map(resultJson);
        }
    }
