...
import com.ajaxjs.devtools.jmxmonitor.TomcatInfo;
...
public class JvmMonitorController {
    ...
    public boolean test() {
        ...
        System.out.println(tomcatSimplyInfo);
    ...
    public List<Vm> getLocalJvmProcessList() {
    ...
    List<Node> getDomains() {
        ...
        if (msc == null)
            throw new NullPointerException("你需要先连接一个 JVM 进程");
