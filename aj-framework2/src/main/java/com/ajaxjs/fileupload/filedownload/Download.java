...
public class Download {
    ...
    private static String probeContentType(Path file) throws IOException {
        String contentType = Files.probeContentType(file);

        return contentType == null ? MediaType.APPLICATION_OCTET_STREAM_VALUE : contentType;
    }

    private static ContentDisposition contentDisposition(String filename, Path file) {
    ...
    private static String sanitizeDownloadName(String filename, Path file) {
