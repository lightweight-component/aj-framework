...
import com.ajaxjs.pay.core.enums.AuthTypeEnum;
import com.ajaxjs.pay.core.enums.PayModel;
import com.ajaxjs.pay.core.enums.RequestMethodEnum;
...
import com.ajaxjs.pay.wxpay.enums.WxDomain;
import com.ajaxjs.pay.wxpay.enums.WxDomainEnum;
import com.ajaxjs.pay.wxpay.enums.v2.*;
import com.ajaxjs.pay.wxpay.enums.xpay.XPayApiEnum;
...
public class WxPayApi {
	...
	public static Map<String, String> getBaseHeaders(String authorization) {
		String userAgent = String.format("WeChatPay-IJPay-HttpClient/%s (%s) Java/%s",
