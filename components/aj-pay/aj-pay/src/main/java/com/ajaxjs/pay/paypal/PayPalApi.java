...
import com.ajaxjs.pay.paypal.model.PayPalApiUrl;
...
public class PayPalApi {
    ...
    public static IJPayHttpResponse getToken(PayPalApiConfig config) {
        ...
        headers.put("Content-Type", HttpConstants.CONTENT_TYPE_FORM);
    ...
    public static Map<String, String> getBaseHeaders(AccessToken accessToken, String payPalRequestId, String payPalPartnerAttributionId, String prefer) {
        if (accessToken == null ||
                StrUtil.isEmptyText(accessToken.getTokenType()) ||
                StrUtil.isEmptyText(accessToken.getAccessToken())) {
