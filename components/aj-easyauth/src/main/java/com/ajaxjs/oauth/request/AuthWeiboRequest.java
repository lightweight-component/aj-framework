...
import com.ajaxjs.oauth.impl.weibo.AuthWeiboScope;
...
public class AuthWeiboRequest extends AuthDefaultRequest {
    ...
    public String authorize(String state) {
        return UrlBuilder.fromBaseUrl(super.authorize(state))
            .queryParam("scope", getScopes(",", false, AuthChecker.getDefaultScopes(AuthWeiboScope.values())))
            .build();
    }
    ...
    public AuthResponse revoke(AuthToken authToken) {
        ...
        ResponseStatus status = object.getBooleanValue("result") ? ResponseStatus.SUCCESS : ResponseStatus.FAILURE;
