...
import com.ajaxjs.oauth.impl.toutiao.ToutiaoErrorCode;
...
public class AuthToutiaoRequest extends AuthDefaultRequest {
    ...
    public AuthUser getUserInfo(AuthToken authToken) {
        ...
        return AuthUser.builder()
            ...
            .gender(UserGender.getRealGender(user.getString("gender")))
            .token(authToken)
    ...
    private void checkResponse(JSONObject object) {
        if (object.containsKey("error_code")) {
            throw new AuthException(ToutiaoErrorCode.getErrorCode(object.getIntValue("error_code")).getDesc());
        }
    }
}
