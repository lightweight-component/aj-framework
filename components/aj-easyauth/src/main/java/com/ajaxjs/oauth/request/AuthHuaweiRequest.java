...
import com.ajaxjs.oauth.enums.scope.AuthHuaweiScope;
...
public class AuthHuaweiRequest extends AuthDefaultRequest {
    ...
    public AuthUser getUserInfo(AuthToken authToken) {
        ...
        UserGender gender = getRealGender(object);
    ...
    public AuthResponse<AuthToken> refresh(AuthToken authToken) {
        ...
        return AuthResponse.<AuthToken>builder().code(ResponseStatus.SUCCESS.getCode()).data(getAuthToken(response)).build();
    }
    ...
    public String authorize(String state) {
        return UrlBuilder.fromBaseUrl(super.authorize(state))
            ...
            .queryParam("scope", this.getScopes(" ", true, AuthChecker.getDefaultScopes(AuthHuaweiScope.values())))
            .build();
    }
