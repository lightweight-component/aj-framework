...
public class ServerParameters {
    ...
    private static final List<String> DEFAULT_INHERITED_ENV_VARS = System.getProperty("os.name").toLowerCase().contains("win")
    ...
    private ServerParameters(String command, List<String> args, Map<String, String> env) {
        Objects.requireNonNull(command, "The command can not be null");
        Objects.requireNonNull(args, "The args can not be null");
    ...
    public static class Builder {
        ...
        public Builder arg(String arg) {
            Objects.requireNonNull(arg, "The arg can not be null");
            this.args.add(arg);
            return this;
        }
