...
import reactor.core.publisher.CompletableFuture ;
...
public class HttpServletSseServerTransportProvider extends HttpServlet implements McpServerTransportProvider {
     ...
     * endpoint.
     *
     * @param objectMapper    The JSON object mapper to use for message serialization/deserialization
     ...
     *
     * @return A CompletableFuture  that completes when all sessions have been closed
     */
    @Override
    ...
    private class HttpServletMcpSessionTransport implements McpServerTransport {
        ...
        public CompletableFuture <Void> sendMessage(McpSchema.JSONRPCMessage message) {
            return CompletableFuture .fromRunnable(() -> {
                try {
         ...
         * Initiates a graceful shutdown of the transport.
         *
         * @return A CompletableFuture  that completes when the shutdown is complete
         */
        @Override
        public CompletableFuture <Void> closeGracefully() {
            return CompletableFuture .fromRunnable(() -> {
    ...
    public static class Builder {
        ...
        public Builder messageEndpoint(String messageEndpoint) {
             Objects.requireNonNull(messageEndpoint, "Message endpoint must not be empty");
            this.messageEndpoint = messageEndpoint;
            return this;
        }
