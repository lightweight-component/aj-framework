package com.ajaxjs.logview.config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry config) {
        config.enableSimpleBroker("/topic");   // 启用简单的消息代理，用于向客户端发送消息
        config.setApplicationDestinationPrefixes("/app"); // 设置应用程序目的地前缀，客户端发送消息时使用
    }
