...
import com.ajaxjs.apidoc.ApiParser;
import com.ajaxjs.apidoc.ExampleGenerator;
import com.ajaxjs.apidoc.JsonGenerator;
import com.ajaxjs.apidoc.model.ApiDocumentation;
...
public class ApiDocController {
    ...
    public String getDocumentationJson(@RequestParam(defaultValue = "all") String environment) {
        return jsonGenerator.toPrettyJson(apiParser.parseAll(environment));
    }
