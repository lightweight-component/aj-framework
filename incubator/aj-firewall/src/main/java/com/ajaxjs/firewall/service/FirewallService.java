...
import com.ajaxjs.firewall.entity.FirewallAccessLog;
import com.ajaxjs.firewall.entity.FirewallStatistics;
import com.ajaxjs.firewall.mapper.FirewallAccessLogMapper;
import com.ajaxjs.firewall.mapper.FirewallStatisticsMapper;
...
public class FirewallService {
    ...
    public void logAccessAsync(FirewallAccessLog accessLog) {
        ...
        updateStatistics(accessLog);    // 更新统计数据
    }
    ...
    private void updateStatistics(FirewallAccessLog accessLog) {
        ...
        FirewallStatistics stats = statisticsMapper.findByDateAndApiPath(today, apiPath);  // 查询今日统计
     ...
     * @return 访问日志列表
     */
    public List<FirewallAccessLog> getAccessLogs(LocalDateTime startTime, LocalDateTime endTime, String ipAddress, String apiPath, Integer limit) {
