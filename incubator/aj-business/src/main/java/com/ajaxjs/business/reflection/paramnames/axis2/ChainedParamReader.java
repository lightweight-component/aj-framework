package com.ajaxjs.business.reflection.paramnames.axis2;
 ...
 * apache bytecode
 * <p>
 * copy from org.apache.axis2.description.java2wsdl.bytecode in axis2-kernel-1.6.2-sources.jar
 * <p>
 * 更新 org.apache.bytecode.ClassReader.java from axis2-kernel 1.8.0-SNAPSTHOT(1.7.9之后的版本)
 * org.apache.axis2.description.java2wsdl.bytecode.ClassReader, 以支持java 高版本(8 9 10 11)生成的class
 * <p>
 * <p>
 * Description: In ParamReader class, user cannot get inherited method parameter
 * from the class they passed in for performance reasons This class is walks up
 * the inheritance chain. If the method is not found in the derived class,
 * search in super class. If not found in the immedidate super class, search
 * super class's super class, until the root, which is java.lang.Object, is
 * reached. This is not an eager load since it only start searching the super
 * class when it is asked to.
 */
public class ChainedParamReader {
    ...
    /**
     * Returns the names of the declared parameters for the given method. If cannot
     * determine the names in the current class, search its parent class until we
     * reach java.lang.Object. If still can not find the method, returns null. The
     * returned array has one name per parameter. The length of the array will be
     * the same as the length of the Class[] array returned by
    ...
    public String[] getParameterNames(Method method) {
        ...
        while (cls != null && cls != Object.class && cls.getSuperclass() != null) {
