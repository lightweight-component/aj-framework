...
import com.ajaxjs.webssh.service.FileTransferService;
import com.ajaxjs.webssh.service.ServerService;
    ...
    public ResponseEntity<Map<String, Object>> uploadFile(
        ...
        try {
            ...
            if (!serverOpt.isPresent())
                return ResponseEntity.badRequest().body(Map.of("success", false, "message", "服务器不存在"));
