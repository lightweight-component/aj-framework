...
public class TestBannedWords {
    @Test
    public void test() {
        FilteredResult result = WordsFilterUtil.filterTextWithPunctuation("江阴毛纺厂和大江阴毛纺厂生产的毛巾都来自姗姗来迟地毯厂，但是，来*迟!地(毯)生产的毛巾不错", '*');
        ...
        System.out.println("\n\n\n");
        result = WordsFilterUtil.filterTextWithPunctuation("网■站黄■色■漫△画▲网站", '*');
...
//		str = "黄色小说<script>function aaa(){alert('胡锦涛一党专制');}</script><p><a class=\"vico\" href=\"http://news.qq.com/a/20100910/000341.htm\"><font color=\"#1f376d\">胡</font>锦<font color=\"#1f376d\">涛考察人民大学 向教师祝贺节日，89风波购买了二十四端口交换机送给老师！GCD，黄瓜葫芦！</font></a></p>";
        ...
        System.out.println("hasSensiviWords:" + result.getHasSensitiveWords());
        start = System.currentTimeMillis();
        result = WordsFilterUtil.filterTextWithPunctuation(str, '*');
