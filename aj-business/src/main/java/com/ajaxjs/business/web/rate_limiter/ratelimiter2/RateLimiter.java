...
import com.ajaxjs.business.web.rate_limiter.ratelimiter2.config.FileRuleConfigSource;
import com.ajaxjs.business.web.rate_limiter.ratelimiter2.config.RuleConfig;
import com.ajaxjs.business.web.rate_limiter.ratelimiter2.config.RuleConfigSource;
import com.ajaxjs.business.web.rate_limiter.ratelimiter2.model.ApiLimit;
...
//        Assert.isTrue(ruleConfig != null, "Load from yaml file, RuleConfig is null");
    ...
    public boolean limit(String appId, String url) throws InterruptedException {
        ...
        if (rateLimitAlg == null) {
            ...
            if (rateLimitCounterOld == null) rateLimitAlg = rateLimitCounterNew;
        }
