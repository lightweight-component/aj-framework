//package com.ajaxjs.web.url_limit;//package com.ajaxs.url_limit;
//
//
...
//        return redisUtil.redisTemplate.hasKey(LOCK_IP_URL_KEY + ip);
//    }
//
//    /**
//     * @param ip
...
//
//        if (Boolean.TRUE.equals(redisUtil.redisTemplate.hasKey(key))) {
//            long time = redisUtil.redisTemplate.incr(key, (long) 1);
//
//            if (time >= LIMIT_TIMES) {
