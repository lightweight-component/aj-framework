...
import com.ajaxjs.business.json.simple2.tokenizer.Token;
import com.ajaxjs.business.json.simple2.tokenizer.TokenList;
import com.ajaxjs.business.json.simple2.tokenizer.TokenType;
...
public class Parser {
    ...
    private void checkExpectToken(TokenType tokenType, int expectToken) {
        if ((tokenType.getTokenCode() & expectToken) == 0) throw new JsonParseException("Parse error, invalid Token.");
    }
}
