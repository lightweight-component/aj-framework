...
public class NativeUtils {
    ...
    /**
     * 从jar包中加载动态库 先将jar包中的动态库复制到系统临时文件夹，然后加载动态库，并且在JVM退出时自动删除。 The file from JAR is
     * copied into system temporary directory and then loaded. The temporary file is
