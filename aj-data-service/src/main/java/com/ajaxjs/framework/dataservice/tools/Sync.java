...
//		Map<String, Object> columnMap = (Map<String, Object>) sql.get("map");
    ...
    public String getSql(Map<String, Object> map, String tableName, String typeR) {
        ...
        for (Map<String, Object> rowMap : rows) {
            if ("mysql".equals(typeR))
                sb.append("`").append(rowMap.get("COLUMN_NAME")).append("` ");
            else
                sb.append("   ").append(rowMap.get("COLUMN_NAME")).append("  ");
        ...
        if ("mysql".equals(type)) {
            switch (((String) typeName).toUpperCase()) {
                ...
                case "VARCHAR2":
                    ...
                    break;
                default:
                    typeCloud = ((String) typeName).toUpperCase();
                    break;
            }
    ...
    public Map<String, Object> sqlTemplate(List<Map<String, Object>> list, String tableName) {
        ...
        map.put("sqlTemplate", sb.toString());
